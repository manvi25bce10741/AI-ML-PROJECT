...
WORKING PRINCIPLE
The system follows a weighted decision-making approach:
User inputs are collected
Scores are assigned to each platform based on predefined conditions
All platforms are ranked according to their scores
The top two platforms are recommended
A score breakdown is displayed to explain the decision
This approach simulates intelligent behavior and mimics basic recommendation systems.
